                        ...
                        <div data-theme="cupcake" class="bg-gray-100 rounded-md shadow dark:border md:mt-0 sm:max-w-xl xl:p-0">
                            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                                ...
                                <form class="space-y-4 md:space-y-6" action="../../php/login.php" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-block border-none text-gray-50 btn-secondary hover:bg-pink-400">Sign in</button>
                                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                        Don't have an account? <a href="/views/signup/index.php" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up here!</a>
                                    </p>
                                </form>
                            </div>
                        </div>
